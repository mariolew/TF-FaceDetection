...
from models import fcn_24_cal


def train():

    lists = ['cal_24_train.txt']
    image_train, label_train = inputs_without_crop(lists, [24, 24, 3], 64)

    net_output = fcn_24_cal()
    ...
    # saver.restore(sess, 'model/model_cal_24-23395')
    try:
        for i in range(400000):
            ...
            if i%10000==0 and i!=0:
                ...
                saver.save(sess, 'model/model_cal_24', global_step=global_step, write_meta_graph=False)
